...
define(['exports', './Matrix2-b06ef836', './RuntimeError-ffe03243', './when-229515d6', './ComponentDatatype-dc3af6a4'], (function (exports, Matrix2, RuntimeError, when, ComponentDatatype) { 'use strict';
  ...
  function computeProperties(ellipsoidRhumbLine, start, end, ellipsoid) {
    ...
    ellipsoidRhumbLine._start = Matrix2.Cartographic.clone(
      start,
  ...
  function interpolateUsingSurfaceDistance(
    ...
    if (distance === 0.0) {
      return Matrix2.Cartographic.clone(start, result);
    }
    ...
    return new Matrix2.Cartographic(longitude, latitude, 0);
  }
  ...
  EllipsoidRhumbLine.fromStartHeadingDistance = function (
    ...
    heading = ComponentDatatype.CesiumMath.negativePiToPi(heading);
  ...
  EllipsoidRhumbLine.prototype.findIntersectionWithLongitude = function (
    ...
    if (!when.defined(result)) {
      result = new Matrix2.Cartographic();
    }
    ...
    var leftComponent =
      Math.tan(0.5 * (ComponentDatatype.CesiumMath.PI_OVER_TWO + phi1)) *
  ...
  EllipsoidRhumbLine.prototype.findIntersectionWithLatitude = function (
    ...
    var longitude = ComponentDatatype.CesiumMath.negativePiToPi(start.longitude + deltaLongitude);
    ...
    return new Matrix2.Cartographic(longitude, intersectionLatitude, 0);
  };
