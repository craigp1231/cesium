...
define(['exports', './GeometryOffsetAttribute-036749bc', './Transforms-e254a706', './Matrix2-b06ef836', './ComponentDatatype-dc3af6a4', './CylinderGeometryLibrary-421d70ff', './when-229515d6', './RuntimeError-ffe03243', './GeometryAttribute-b662d87a', './GeometryAttributes-b253752a', './IndexDatatype-87b580b0', './VertexFormat-64c5c4fb'], (function (exports, GeometryOffsetAttribute, Transforms, Matrix2, ComponentDatatype, CylinderGeometryLibrary, when, RuntimeError, GeometryAttribute, GeometryAttributes, IndexDatatype, VertexFormat) { 'use strict';
  ...
  CylinderGeometry.createGeometry = function (cylinderGeometry) {
    ...
    if (computeNormal) {
      ...
      for (i = 0; i < slices; i++) {
        var angle = (i / slices) * ComponentDatatype.CesiumMath.TWO_PI;
    ...
    if (vertexFormat.st) {
      ...
      for (i = 0; i < numVertices; i++) {
        var position = Matrix2.Cartesian3.fromArray(positions, i * 3, positionScratch);
