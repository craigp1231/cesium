...
define(['./when-229515d6', './Matrix2-b06ef836', './ArcType-1da7fdca', './GeometryOffsetAttribute-036749bc', './BoundingRectangle-1334873e', './Transforms-e254a706', './RuntimeError-ffe03243', './ComponentDatatype-dc3af6a4', './EllipsoidGeodesic-c1f5c63d', './EllipsoidTangentPlane-16e686c1', './GeometryAttribute-b662d87a', './GeometryInstance-859d322e', './GeometryPipeline-78f66d53', './IndexDatatype-87b580b0', './PolygonGeometryLibrary-11d113bc', './PolygonPipeline-95c28d40', './VertexFormat-64c5c4fb', './combine-8ce3f24b', './WebGLConstants-4e26b85a', './AxisAlignedBoundingBox-4e74fa8b', './IntersectionTests-8df35d37', './Plane-5d90414b', './AttributeCompression-0d03c199', './EncodedCartesian3-1c4d2319', './arrayRemoveDuplicates-0d347b8b', './EllipsoidRhumbLine-924404c2', './GeometryAttributes-b253752a'], (function (when, Matrix2, ArcType, GeometryOffsetAttribute, BoundingRectangle, Transforms, RuntimeError, ComponentDatatype, EllipsoidGeodesic, EllipsoidTangentPlane, GeometryAttribute, GeometryInstance, GeometryPipeline, IndexDatatype, PolygonGeometryLibrary, PolygonPipeline, VertexFormat, combine, WebGLConstants, AxisAlignedBoundingBox, IntersectionTests, Plane, AttributeCompression, EncodedCartesian3, arrayRemoveDuplicates, EllipsoidRhumbLine, GeometryAttributes) { 'use strict';
  ...
  function computeAttributes(options) {
    ...
    if (
      ...
      for (var i = 0; i < length; i += 3) {
        var position = Matrix2.Cartesian3.fromArray(
          flatPositions,
          i,
        ...
        if (
          ...
          if (wall) {
            if (i + 3 < length) {
              ...
              if (recomputeNormal) {
                var p2 = Matrix2.Cartesian3.fromArray(
                  flatPositions,
                  i + length,
                  p2Scratch
                );
