...
define(['exports', './Transforms-e254a706', './ComponentDatatype-dc3af6a4', './when-229515d6', './RuntimeError-ffe03243', './Matrix2-b06ef836', './GeometryAttribute-b662d87a', './GeometryAttributes-b253752a', './GeometryPipeline-78f66d53', './IndexDatatype-87b580b0', './WebMercatorProjection-89ad70fb'], (function (exports, Transforms, ComponentDatatype, when, RuntimeError, Matrix2, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) { 'use strict';
  ...
  function unpackInstancesForCombine(data) {
    ...
    while (i < packedInstances.length) {
      var modelMatrix = Matrix2.Matrix4.unpack(packedInstances, i);
      var attributes;
  ...
  PrimitivePipeline.unpackCombineGeometryParameters = function (
    ...
    var ellipsoid = Matrix2.Ellipsoid.clone(packedParameters.ellipsoid);
...
//# sourceMappingURL=PrimitivePipeline-a5ee7b8e.js.map
