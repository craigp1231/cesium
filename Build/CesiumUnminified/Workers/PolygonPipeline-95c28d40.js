...
define(['exports', './Matrix2-b06ef836', './RuntimeError-ffe03243', './ComponentDatatype-dc3af6a4', './when-229515d6', './EllipsoidRhumbLine-924404c2', './GeometryAttribute-b662d87a', './WebGLConstants-4e26b85a'], (function (exports, Matrix2, RuntimeError, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, WebGLConstants) { 'use strict';
    ...
    var scaleToGeodeticHeightN = new Matrix2.Cartesian3();
    var scaleToGeodeticHeightP = new Matrix2.Cartesian3();
    ...
    PolygonPipeline.triangulate = function (positions, holes) {
      ...
      var flattenedPositions = Matrix2.Cartesian2.packArray(positions);
      return earcut_1(flattenedPositions, holes, 2);
    };

    var subdivisionV0Scratch = new Matrix2.Cartesian3();
    var subdivisionV1Scratch = new Matrix2.Cartesian3();
    var subdivisionV2Scratch = new Matrix2.Cartesian3();
    var subdivisionS0Scratch = new Matrix2.Cartesian3();
    var subdivisionS1Scratch = new Matrix2.Cartesian3();
    var subdivisionS2Scratch = new Matrix2.Cartesian3();
    var subdivisionMidScratch = new Matrix2.Cartesian3();
    ...
    PolygonPipeline.computeSubdivision = function (
      ...
      var minDistance = ComponentDatatype.CesiumMath.chordLength(granularity, radius);
      ...
      while (triangles.length > 0) {
        ...
        var v0 = Matrix2.Cartesian3.fromArray(
          subdividedPositions,
          i0 * 3,
          subdivisionV0Scratch
        );
        var v1 = Matrix2.Cartesian3.fromArray(
          subdividedPositions,
          i1 * 3,
          subdivisionV1Scratch
        );
        var v2 = Matrix2.Cartesian3.fromArray(
          subdividedPositions,
          i2 * 3,
          subdivisionV2Scratch
        );

        var s0 = Matrix2.Cartesian3.multiplyByScalar(
          Matrix2.Cartesian3.normalize(v0, subdivisionS0Scratch),
          radius,
          subdivisionS0Scratch
        );
        var s1 = Matrix2.Cartesian3.multiplyByScalar(
          Matrix2.Cartesian3.normalize(v1, subdivisionS1Scratch),
          radius,
          subdivisionS1Scratch
        );
        var s2 = Matrix2.Cartesian3.multiplyByScalar(
          Matrix2.Cartesian3.normalize(v2, subdivisionS2Scratch),
          radius,
          subdivisionS2Scratch
        );

        var g0 = Matrix2.Cartesian3.magnitudeSquared(
          Matrix2.Cartesian3.subtract(s0, s1, subdivisionMidScratch)
        );
        var g1 = Matrix2.Cartesian3.magnitudeSquared(
          Matrix2.Cartesian3.subtract(s1, s2, subdivisionMidScratch)
        );
        var g2 = Matrix2.Cartesian3.magnitudeSquared(
    ...
    var subdivisionC0Scratch = new Matrix2.Cartographic();
    var subdivisionC1Scratch = new Matrix2.Cartographic();
    var subdivisionC2Scratch = new Matrix2.Cartographic();
    var subdivisionCartographicScratch = new Matrix2.Cartographic();
...
//# sourceMappingURL=PolygonPipeline-95c28d40.js.map
