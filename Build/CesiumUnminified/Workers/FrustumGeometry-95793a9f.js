...
define(['exports', './Transforms-e254a706', './Matrix2-b06ef836', './RuntimeError-ffe03243', './ComponentDatatype-dc3af6a4', './when-229515d6', './GeometryAttribute-b662d87a', './GeometryAttributes-b253752a', './Plane-5d90414b', './VertexFormat-64c5c4fb'], (function (exports, Transforms, Matrix2, RuntimeError, ComponentDatatype, when, GeometryAttribute, GeometryAttributes, Plane, VertexFormat) { 'use strict';
  ...
  var faces = [new Matrix2.Cartesian3(), new Matrix2.Cartesian3(), new Matrix2.Cartesian3()];
  ...
  var scratchPlaneCenter = new Matrix2.Cartesian3();
  var scratchPlaneNormal = new Matrix2.Cartesian3();
  var scratchPlane = new Plane.Plane(new Matrix2.Cartesian3(1.0, 0.0, 0.0), 0.0);
  ...
  var getPlanesRight$1 = new Matrix2.Cartesian3();
  var getPlanesNearCenter$1 = new Matrix2.Cartesian3();
  var getPlanesPoint = new Matrix2.Cartesian3();
  var negateScratch = new Matrix2.Cartesian3();
  ...
  OrthographicOffCenterFrustum.prototype.computeCullingVolume = function (
    ...
    var right = Matrix2.Cartesian3.cross(direction, up, getPlanesRight$1);
  ...
  var getPlanesRight = new Matrix2.Cartesian3();
  var getPlanesNearCenter = new Matrix2.Cartesian3();
  var getPlanesFarCenter = new Matrix2.Cartesian3();
  var getPlanesNormal = new Matrix2.Cartesian3();
  /**
   * Creates a culling volume for this frustum.
   *
   * @param {Cartesian3} position The eye position.
  ...
  PerspectiveOffCenterFrustum.prototype.computeCullingVolume = function (
    ...
    var right = Matrix2.Cartesian3.cross(direction, up, getPlanesRight);
  ...
  var scratchRotationMatrix = new Matrix2.Matrix3();
  var scratchViewMatrix = new Matrix2.Matrix4();
  var scratchInverseMatrix = new Matrix2.Matrix4();

  var scratchXDirection = new Matrix2.Cartesian3();
  var scratchYDirection = new Matrix2.Cartesian3();
  var scratchZDirection = new Matrix2.Cartesian3();
  var scratchNegativeX = new Matrix2.Cartesian3();
  var scratchNegativeY = new Matrix2.Cartesian3();
  var scratchNegativeZ = new Matrix2.Cartesian3();
  ...
  FrustumGeometry._computeNearFarPlanes = function (
    ...
    var rotationMatrix = Matrix2.Matrix3.fromQuaternion(
      orientation,
    ...
    var view = Matrix2.Matrix4.computeView(origin, z, y, x, scratchViewMatrix);

    var inverseView;
    var inverseViewProjection;
    if (frustumType === PERSPECTIVE) {
      var projection = frustum.projectionMatrix;
      var viewProjection = Matrix2.Matrix4.multiply(
        projection,
        view,
    ...
    for (var i = 0; i < 2; ++i) {
      for (var j = 0; j < 4; ++j) {
        var corner = Matrix2.Cartesian4.clone(
          frustumCornersNDC[j],
        ...
        if (!when.defined(inverseViewProjection)) {
          ...
          var fac = Matrix2.Cartesian3.dot(z, corner);
  ...
  FrustumGeometry.createGeometry = function (frustumGeometry) {
    ...
    if (
      ...
      var negativeX = Matrix2.Cartesian3.negate(x, scratchNegativeX);
      var negativeY = Matrix2.Cartesian3.negate(y, scratchNegativeY);
      var negativeZ = Matrix2.Cartesian3.negate(z, scratchNegativeZ);
