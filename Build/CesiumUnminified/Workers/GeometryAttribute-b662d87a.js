...
define(['exports', './Matrix2-b06ef836', './RuntimeError-ffe03243', './when-229515d6', './WebGLConstants-4e26b85a', './Transforms-e254a706'], (function (exports, Matrix2, RuntimeError, when, WebGLConstants, Transforms) { 'use strict';
  ...
  var enuCenterScratch = new Matrix2.Cartesian3();
  var fixedFrameToEnuScratch = new Matrix2.Matrix4();
  ...
  var pointEnuScratch = new Matrix2.Cartesian3();
  var enuRotationScratch = new Transforms.Quaternion();
  var enuRotationMatrixScratch = new Matrix2.Matrix4();
  ...
  Geometry._textureCoordinateRotationPoints = function (
    ...
    var rectangleCenter = Matrix2.Rectangle.center(
      boundingRectangle,
      rectangleCenterScratch
    );
    var enuCenter = Matrix2.Cartographic.toCartesian(
      rectangleCenter,
      ellipsoid,
      enuCenterScratch
    );
    ...
    var fixedFrameToEnu = Matrix2.Matrix4.inverse(
      enuToFixedFrame,
      fixedFrameToEnuScratch
    );
    ...
    var toDesiredInComputed = Matrix2.Matrix2.fromRotation(stRotation, rotation2DScratch);
...
//# sourceMappingURL=GeometryAttribute-b662d87a.js.map
