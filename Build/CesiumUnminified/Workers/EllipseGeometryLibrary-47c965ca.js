...
define(['exports', './Matrix2-b06ef836', './ComponentDatatype-dc3af6a4', './Transforms-e254a706'], (function (exports, Matrix2, ComponentDatatype, Transforms) { 'use strict';

  var EllipseGeometryLibrary = {};

  var rotAxis = new Matrix2.Cartesian3();
  var tempVec = new Matrix2.Cartesian3();
  var unitQuat = new Transforms.Quaternion();
  var rotMtx = new Matrix2.Matrix3();
  ...
  EllipseGeometryLibrary.raisePositionsToHeight = function (
    ...
    for (var i = 0; i < length; i += 3) {
      ...
      var extrudedPosition = Matrix2.Cartesian3.clone(position, scratchCartesian2);
  ...
  var unitPosScratch = new Matrix2.Cartesian3();
  var eastVecScratch = new Matrix2.Cartesian3();
  var northVecScratch = new Matrix2.Cartesian3();
  /**
  ...
  EllipseGeometryLibrary.computeEllipsePositions = function (
    ...
    var mag = Matrix2.Cartesian3.magnitude(center);

    var unitPos = Matrix2.Cartesian3.normalize(center, unitPosScratch);
    var eastVec = Matrix2.Cartesian3.cross(Matrix2.Cartesian3.UNIT_Z, center, eastVecScratch);
    eastVec = Matrix2.Cartesian3.normalize(eastVec, eastVec);
    var northVec = Matrix2.Cartesian3.cross(unitPos, eastVec, northVecScratch);

    // The number of points in the first quadrant
    var numPts = 1 + Math.ceil(ComponentDatatype.CesiumMath.PI_OVER_TWO / granularity);

    var deltaTheta = ComponentDatatype.CesiumMath.PI_OVER_TWO / (numPts - 1);
    var theta = ComponentDatatype.CesiumMath.PI_OVER_TWO - numPts * deltaTheta;
    if (theta < 0.0) {
...
//# sourceMappingURL=EllipseGeometryLibrary-47c965ca.js.map
