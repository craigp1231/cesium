...
define(['exports', './Matrix2-b06ef836', './when-229515d6', './RuntimeError-ffe03243', './EllipsoidGeodesic-c1f5c63d', './EllipsoidRhumbLine-924404c2', './IntersectionTests-8df35d37', './ComponentDatatype-dc3af6a4', './Plane-5d90414b'], (function (exports, Matrix2, when, RuntimeError, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, ComponentDatatype, Plane) { 'use strict';
  ...
  var cartoScratch = new Matrix2.Cartographic();
  ...
  var wrapLongitudeInversMatrix = new Matrix2.Matrix4();
  var wrapLongitudeOrigin = new Matrix2.Cartesian3();
  var wrapLongitudeXZNormal = new Matrix2.Cartesian3();
  var wrapLongitudeXZPlane = new Plane.Plane(Matrix2.Cartesian3.UNIT_X, 0.0);
  var wrapLongitudeYZNormal = new Matrix2.Cartesian3();
  var wrapLongitudeYZPlane = new Plane.Plane(Matrix2.Cartesian3.UNIT_X, 0.0);
  var wrapLongitudeIntersection = new Matrix2.Cartesian3();
  var wrapLongitudeOffset = new Matrix2.Cartesian3();
  ...
  var carto1 = new Matrix2.Cartographic();
  var carto2 = new Matrix2.Cartographic();
  var cartesian = new Matrix2.Cartesian3();
  var scaleFirst = new Matrix2.Cartesian3();
  var scaleLast = new Matrix2.Cartesian3();
  ...
  PolylinePipeline.wrapLongitude = function (positions, modelMatrix) {
    ...
    if (when.defined(positions) && positions.length > 0) {
      modelMatrix = when.defaultValue(modelMatrix, Matrix2.Matrix4.IDENTITY);
      var inverseModelMatrix = Matrix2.Matrix4.inverseTransformation(
        modelMatrix,
        wrapLongitudeInversMatrix
      );

      var origin = Matrix2.Matrix4.multiplyByPoint(
        inverseModelMatrix,
        Matrix2.Cartesian3.ZERO,
        wrapLongitudeOrigin
      );
      var xzNormal = Matrix2.Cartesian3.normalize(
      ...
      var yzNormal = Matrix2.Cartesian3.normalize(
        Matrix2.Matrix4.multiplyByPointAsVector(
          inverseModelMatrix,
...
//# sourceMappingURL=PolylinePipeline-24e9fd21.js.map
