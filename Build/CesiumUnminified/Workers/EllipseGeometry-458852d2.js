...
define(['exports', './GeometryOffsetAttribute-036749bc', './Transforms-e254a706', './Matrix2-b06ef836', './RuntimeError-ffe03243', './ComponentDatatype-dc3af6a4', './when-229515d6', './EllipseGeometryLibrary-47c965ca', './GeometryAttribute-b662d87a', './GeometryAttributes-b253752a', './GeometryInstance-859d322e', './GeometryPipeline-78f66d53', './IndexDatatype-87b580b0', './VertexFormat-64c5c4fb'], (function (exports, GeometryOffsetAttribute, Transforms, Matrix2, RuntimeError, ComponentDatatype, when, EllipseGeometryLibrary, GeometryAttribute, GeometryAttributes, GeometryInstance, GeometryPipeline, IndexDatatype, VertexFormat) { 'use strict';
  ...
  var texCoordScratch = new Matrix2.Cartesian2();
  ...
  var projectedCenterScratch = new Matrix2.Cartesian3();

  var scratchMinTexCoord = new Matrix2.Cartesian2();
  var scratchMaxTexCoord = new Matrix2.Cartesian2();
  ...
  function computeTopBottomAttributes(positions, options, extrude) {
    ...
    var minTexCoord = Matrix2.Cartesian2.fromElements(
      Number.POSITIVE_INFINITY,
      Number.POSITIVE_INFINITY,
      scratchMinTexCoord
    );
    var maxTexCoord = Matrix2.Cartesian2.fromElements(
    ...
    for (var i = 0; i < length; i += 3) {
      var i1 = i + 1;
      var i2 = i + 2;
      var position = Matrix2.Cartesian3.fromArray(positions, i, scratchCartesian1);

      if (vertexFormat.st) {
        var rotatedPoint = Matrix2.Matrix3.multiplyByVector(
          textureMatrix,
          position,
          scratchCartesian2
        );
  ...
  function computeWallAttributes(positions, options) {
    ...
    var textureMatrix = Matrix2.Matrix3.fromQuaternion(rotation, textureMatrixScratch);
    ...
    for (var i = 0; i < length; i += 3) {
      ...
      if (vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
        ...
        var next = Matrix2.Cartesian3.fromArray(
          positions,
          (i + 3) % length,
          scratchCartesian4
        );
        Matrix2.Cartesian3.subtract(next, position, next);
        var bottom = Matrix2.Cartesian3.subtract(
          extrudedPosition,
          position,
          scratchCartesian3
        );
  ...
  function computeRectangle(
    ...
    var rectangle = Matrix2.Rectangle.fromCartesianArray(positions, ellipsoid, result);
...
//# sourceMappingURL=EllipseGeometry-458852d2.js.map
