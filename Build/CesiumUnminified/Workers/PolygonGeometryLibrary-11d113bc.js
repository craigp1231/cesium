...
define(['exports', './ArcType-1da7fdca', './arrayRemoveDuplicates-0d347b8b', './Matrix2-b06ef836', './ComponentDatatype-dc3af6a4', './when-229515d6', './EllipsoidRhumbLine-924404c2', './GeometryAttribute-b662d87a', './GeometryAttributes-b253752a', './GeometryPipeline-78f66d53', './IndexDatatype-87b580b0', './PolygonPipeline-95c28d40', './Transforms-e254a706'], (function (exports, ArcType, arrayRemoveDuplicates, Matrix2, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, PolygonPipeline, Transforms) { 'use strict';
  ...
  var distanceScratch = new Matrix2.Cartesian3();
  ...
  PolygonGeometryLibrary.subdivideLineCount = function (p0, p1, minDistance) {
    var distance = Matrix2.Cartesian3.distance(p0, p1);
    var n = distance / minDistance;
    var countDivide = Math.max(0, Math.ceil(ComponentDatatype.CesiumMath.log2(n)));
    return Math.pow(2, countDivide);
  };

  var scratchCartographic0 = new Matrix2.Cartographic();
  var scratchCartographic1 = new Matrix2.Cartographic();
  var scratchCartographic2 = new Matrix2.Cartographic();
  var scratchCartesian0 = new Matrix2.Cartesian3();
  ...
  PolygonGeometryLibrary.subdivideLine = function (p0, p1, minDistance, result) {
    ...
    var length = Matrix2.Cartesian3.distance(p0, p1);
  ...
  var scaleToGeodeticHeightN1 = new Matrix2.Cartesian3();
  var scaleToGeodeticHeightN2 = new Matrix2.Cartesian3();
  var scaleToGeodeticHeightP1 = new Matrix2.Cartesian3();
  var scaleToGeodeticHeightP2 = new Matrix2.Cartesian3();
  ...
  var computeBoundingRectangleCartesian3 = new Matrix2.Cartesian3();
  var computeBoundingRectangleQuaternion = new Transforms.Quaternion();
  var computeBoundingRectangleMatrix3 = new Matrix2.Matrix3();
  PolygonGeometryLibrary.computeBoundingRectangle = function (
    ...
    var textureMatrix = Matrix2.Matrix3.fromQuaternion(
      rotation,
    ...
    for (var i = 0; i < length; ++i) {
      var p = Matrix2.Cartesian3.clone(positions[i], computeBoundingRectangleCartesian3);
...
//# sourceMappingURL=PolygonGeometryLibrary-11d113bc.js.map
