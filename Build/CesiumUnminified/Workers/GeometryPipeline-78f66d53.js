...
define(['exports', './AttributeCompression-0d03c199', './Matrix2-b06ef836', './RuntimeError-ffe03243', './when-229515d6', './ComponentDatatype-dc3af6a4', './Transforms-e254a706', './EncodedCartesian3-1c4d2319', './GeometryAttribute-b662d87a', './IndexDatatype-87b580b0', './IntersectionTests-8df35d37', './Plane-5d90414b'], (function (exports, AttributeCompression, Matrix2, RuntimeError, when, ComponentDatatype, Transforms, EncodedCartesian3, GeometryAttribute, IndexDatatype, IntersectionTests, Plane) { 'use strict';
  ...
  var scratchProjectTo2DCartesian3 = new Matrix2.Cartesian3();
  var scratchProjectTo2DCartographic = new Matrix2.Cartographic();
  ...
  GeometryPipeline.projectTo2D = function (
    ...
    for (var i = 0; i < values3D.length; i += 3) {
      var value = Matrix2.Cartesian3.fromArray(values3D, i, scratchProjectTo2DCartesian3);
  ...
  var inverseTranspose = new Matrix2.Matrix4();
  var normalMatrix = new Matrix2.Matrix3();
  ...
  var tempScratch = new Matrix2.Cartesian3();
  ...
  function combineGeometries(instances, propertyName) {
    ...
    var center = new Matrix2.Cartesian3();
    var radius = 0.0;
    var bs;
  ...
  var normal = new Matrix2.Cartesian3();
  var v0 = new Matrix2.Cartesian3();
  var v1 = new Matrix2.Cartesian3();
  var v2 = new Matrix2.Cartesian3();
  ...
  var normalScale = new Matrix2.Cartesian3();
  var tScratch = new Matrix2.Cartesian3();
  ...
  GeometryPipeline.computeTangentAndBitangent = function (geometry) {
    ...
    for (i = 0; i < numVertices; i++) {
      ...
      var n = Matrix2.Cartesian3.fromArray(normals, i03, normalScratch);
      var t = Matrix2.Cartesian3.fromArray(tan1, i03, tScratch);
      var scalar = Matrix2.Cartesian3.dot(n, t);
  ...
  var scratchCartesian2 = new Matrix2.Cartesian2();
  var toEncode1 = new Matrix2.Cartesian3();
  var toEncode2 = new Matrix2.Cartesian3();
  var toEncode3 = new Matrix2.Cartesian3();
  var encodeResult2 = new Matrix2.Cartesian2();
  /**
  ...
  var u1 = new Matrix2.Cartesian3();
  var u2 = new Matrix2.Cartesian3();
  var q1 = new Matrix2.Cartesian3();
  var q2 = new Matrix2.Cartesian3();
  ...
  var p0Scratch = new Matrix2.Cartesian3();
  var p1Scratch = new Matrix2.Cartesian3();
  var p2Scratch = new Matrix2.Cartesian3();
  var barycentricScratch = new Matrix2.Cartesian3();
  ...
  function computeTriangleAttributes(
    ...
    var p0 = Matrix2.Cartesian3.fromArray(positions, i0 * 3, p0Scratch);
    var p1 = Matrix2.Cartesian3.fromArray(positions, i1 * 3, p1Scratch);
    var p2 = Matrix2.Cartesian3.fromArray(positions, i2 * 3, p2Scratch);
    ...
    if (when.defined(extrudeDirections)) {
      var d0 = Matrix2.Cartesian3.fromArray(extrudeDirections, i0 * 3, p0Scratch);
      var d1 = Matrix2.Cartesian3.fromArray(extrudeDirections, i1 * 3, p1Scratch);
      var d2 = Matrix2.Cartesian3.fromArray(extrudeDirections, i2 * 3, p2Scratch);
  ...
  function splitLongitudeTriangles(instance) {
    ...
    for (i = 0; i < len; i += 3) {
      ...
      var p0 = Matrix2.Cartesian3.fromArray(positions, i0 * 3);
      var p1 = Matrix2.Cartesian3.fromArray(positions, i1 * 3);
      var p2 = Matrix2.Cartesian3.fromArray(positions, i2 * 3);
  ...
  var xzPlane = Plane.Plane.fromPointNormal(Matrix2.Cartesian3.ZERO, Matrix2.Cartesian3.UNIT_Y);

  var offsetScratch = new Matrix2.Cartesian3();
  var offsetPointScratch = new Matrix2.Cartesian3();
  ...
  function splitLongitudeLines(instance) {
    ...
    for (i = 0; i < length; i += 2) {
      ...
      if (when.defined(intersection)) {
        ...
        var offset = Matrix2.Cartesian3.multiplyByScalar(
        ...
        var offsetPoint = Matrix2.Cartesian3.add(
          intersection,
          offset,
          offsetPointScratch
        );
  ...
  var cartesian2Scratch0 = new Matrix2.Cartesian2();
  var cartesian2Scratch1 = new Matrix2.Cartesian2();

  var cartesian3Scratch0 = new Matrix2.Cartesian3();
  var cartesian3Scratch2 = new Matrix2.Cartesian3();
  var cartesian3Scratch3 = new Matrix2.Cartesian3();
  var cartesian3Scratch4 = new Matrix2.Cartesian3();
  var cartesian3Scratch5 = new Matrix2.Cartesian3();
  var cartesian3Scratch6 = new Matrix2.Cartesian3();

  var cartesian4Scratch0 = new Matrix2.Cartesian4();
  ...
  function updateAdjacencyAfterSplit(geometry) {
    ...
    for (var j = 0; j < length; j += 3) {
      var position = Matrix2.Cartesian3.unpack(positions, j, cartesian3Scratch0);
      if (position.x > 0.0) {
        continue;
      }

      var prevPosition = Matrix2.Cartesian3.unpack(prevPositions, j, cartesian3Scratch2);
      if (
      ...
      var nextPosition = Matrix2.Cartesian3.unpack(nextPositions, j, cartesian3Scratch3);
      if (
  ...
  var offsetScalar = 5.0 * ComponentDatatype.CesiumMath.EPSILON9;
  var coplanarOffset = ComponentDatatype.CesiumMath.EPSILON6;
  ...
  function splitLongitudePolyline(instance) {
    ...
    for (i = 0; i < length; i += 4) {
      ...
      var p0 = Matrix2.Cartesian3.fromArray(positions, i0 * 3, cartesian3Scratch0);
      var p2 = Matrix2.Cartesian3.fromArray(positions, i2 * 3, cartesian3Scratch2);
      ...
      if (when.defined(intersection)) {
        ...
        var ew0 = Matrix2.Cartesian2.fromArray(
          expandAndWidths,
          i0 * 2,
          cartesian2Scratch0
        );
        ...
        var t = Matrix2.Cartesian3.magnitudeSquared(
        ...
        if (when.defined(colors)) {
          var c0 = Matrix2.Cartesian4.fromArray(colors, i0 * 4, cartesian4Scratch0);
          var c2 = Matrix2.Cartesian4.fromArray(colors, i2 * 4, cartesian4Scratch0);

          var r = ComponentDatatype.CesiumMath.lerp(c0.x, c2.x, t);
          var g = ComponentDatatype.CesiumMath.lerp(c0.y, c2.y, t);
          var b = ComponentDatatype.CesiumMath.lerp(c0.z, c2.z, t);
          var a = ComponentDatatype.CesiumMath.lerp(c0.w, c2.w, t);
        ...
        if (when.defined(texCoords)) {
          var s0 = Matrix2.Cartesian2.fromArray(texCoords, i0 * 2, cartesian2Scratch0);
          var s3 = Matrix2.Cartesian2.fromArray(
            texCoords,
            (i + 3) * 2,
            cartesian2Scratch1
          );

          var sx = ComponentDatatype.CesiumMath.lerp(s0.x, s3.x, t);
